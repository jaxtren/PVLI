...
std::string NVENCstatusString(NVENCSTATUS s);
...
#define NVENC_API_CALL( nvencAPI )                                                                                 \
    ...
    {                                                                                                              \
        ...
        {                                                                                                          \
            std::ostringstream errorLog;                                                                           \
            errorLog << #nvencAPI << " returned " << NVENCstatusString(errorCode);                           \
...
public:
    ...
    */
    void CreateDefaultEncoderParams(NV_ENC_INITIALIZE_PARAMS *pIntializeParams, const VideoEncoderConfig &c);
