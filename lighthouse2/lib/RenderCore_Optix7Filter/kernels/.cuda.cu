...
__device__ cudaSurfaceObject_t renderTarget; // TODO update renderer
...
__host__ void stageMemcpy( void* d, void* s, int n ) {
    // FIXME crash when started pica scene with 1080p, staged from core_mesh
    //StagedCpy c = { d, s, n }; stagedCpy.push_back( c );
...
__constant__ CoreData data;
static CoreData hostData;
...
// compile host-side access points
#define CUDA_HOST_IMPL
#include "host.h"
