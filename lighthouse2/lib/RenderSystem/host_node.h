/* host_node.h - Copyright 2019/2020 Utrecht University
...
public:
	...
	int pointLight = -1; 				// id of the point light this node refers to (if any, -1 otherwise)
	int spotLight = -1;				    // id of the spot light this node refers to (if any, -1 otherwise)
	int directionalLight = -1;          // id of the directional light this node refers to (if any, -1 otherwise)
