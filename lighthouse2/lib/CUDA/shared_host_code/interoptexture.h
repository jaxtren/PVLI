/* interoptexture.h - Copyright 2019/2020 Utrecht University
...
public:
	...
	void LinkToSurface(const cudaSurfaceObject_t s);
	// methods
	void BindSurface();
	void UnbindSurface();
private:
	...
	// TODO update from surfaceReference to cudaSurfaceObject_t
